module.exports= function(app) {
    ...
    routes_habanero= [{'method':'use','path':'','func': general_func},
    ...
    routes_habanero.forEach(function(route) { route.path ? app[route.method](route.path,route.func) : app[route.method](route.func);});
